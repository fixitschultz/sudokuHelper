<?php
/* 
	returns a two digit number from the two single digit that was sent to this function.
*/
...
function saveBoard($board)
{
	...
	file_put_contents($file, $board, FILE_APPEND | LOCK_EX);
}
function compareBoards($board1, $board2)
{
	if (strcmp($board1, $board2) === 0) {
		echo "board1 is equal to board2 \r\n";
		
	}else{
		echo "board1 is not equal to board2 \r\n";
		}
		
}
$board=readBoard();
$board2="123456789597823164486971532315697248648215973279384651754132896861549327932768415";
loadBoard($board);
saveBoard($board);
compareBoards($board,$board);
compareBoards($board,$board2);
//loadBoard($board);
